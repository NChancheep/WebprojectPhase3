...
class Recipe extends React.Component
{
    ...
    render()
    {
        return (
            <div>
                <DivStyle>
                    <H1Style>Explore Recipe</H1Style>
                    <FormStyle onSubmit = {this.handleSubmit}>
                        <LabelStyle>Are you looking for something to cook?:
                            <input 
                                type = "text"
                                name = "search" 
                                id = "search"
                            ...
                            />
                            <input type = "submit" value = "Go go!!" onClick = {this.SearchRecipe}/>
                        </LabelStyle>
                    </FormStyle>
                </DivStyle>
    ...
    SearchRecipe()
    {
        ...
        fetch("https://api.spoonacular.com/recipes/complexSearch?apiKey=" + APi_key + "&query=" + this.state.search,
        {
            method: "GET",
            headers:
            {
